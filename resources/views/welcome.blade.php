...
<body>
    ...
    <nav class="navbar navbar-expand-lg ">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Ashish Dhakal</a>
    ...
    <section class="hero-section container">
        <div class="hero-info">
            ...
            <div class="hero-button">
                ...
                <a name="button-hero" id="" target=”_blank” class="btn btn-primary"
                    href="https://www.upwork.com/freelancers/~0190ef82bd42e4d819" role="button">Hire Me</a>
            </div>
    ...
    <div class="container">
        <section class=" about-section header-section " id="About">
            ...
            <p class="about-me-parag">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia impedit sed
                harum
    ...
    <section class="portfolio container" id="Portfolio">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <a href="https://github.com/Ashish-Dhakal/Hotel-Management-System" target="_blank"> <img
                        src="img/javaproject.jpg" alt=""></a>
            </div>

            <div class="box">
                <a href="https://github.com/Ashish-Dhakal/Ecommerce" target="_blank"><img src="img/emall-image.png"
                        alt=""> alt="" ></a>
            </div>

            <div class="box">
                <a href="https://github.com/Ashish-Dhakal/Ecommerce" target=”_blank”> <img src="img/travel-web.jpg"
                        alt=""> alt="" ></a>
            </div>
    ...
    <section class="service container" id="Service">
        ...
        <div class="service-box">
            <div class="service-content">
                <h4>web design</h4>
                <p>
                <div class="5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Explicabo labore cum
                    corrupti quo asperiores ipsam maxime magnam nulla dicta ipsa dolores enim itaque quae dolorum
                    veritatis sapiente, nemo illum ducimus.</div>
                </p>
            </div>
            <div class="service-content">
                <h4>web design</h4>
    ...
    <section class="contact container" id="Contact">
        ...
        <div class="contact-box">
            ...
            <div class="contact-form">
                ...
                <textarea class="info" name="" id="" cols="25" rows="7"
